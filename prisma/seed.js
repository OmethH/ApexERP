...
function generateStaffData() {
  ...
  for (let i = 0; i < 24; i++) {
    ...
    staff.push({
      ...
      lastName,
      fullName: `${firstName} ${lastName}`,
      email: `${firstName.toLowerCase()}.${lastName.toLowerCase()}${i > 0 ? i : ''}@powerworld.lk`,
      phone: `+94 7${Math.floor(Math.random() * 9)}${Math.floor(1000000 + Math.random() * 9000000)}`,
      role,
      branchId,
...
const usersData = [
  { id: 'USR001', name: 'Admin User', email: 'admin@powerworld.com', password: 'admin123', role: 'Admin', branchId: null, memberId: null, staffId: null },
  { id: 'USR002', name: 'Ruwan Perera', email: 'manager@powerworld.com', password: 'manager123', role: 'Manager', branchId: 'BR001', memberId: null, staffId: null },
  { id: 'USR003', name: 'Kasun Fernando', email: 'staff@powerworld.com', password: 'staff123', role: 'Staff', branchId: 'BR001', memberId: null, staffId: null },
  { id: 'USR004', name: 'Dilshan Jayawardena', email: 'trainer@powerworld.com', password: 'trainer123', role: 'Trainer', branchId: 'BR001', memberId: null, staffId: 'STF004' },
  { id: 'USR005', name: 'Ashan Perera', email: 'customer@powerworld.com', password: 'customer123', role: 'Customer', branchId: 'BR001', memberId: 'MEM001', staffId: null },
];
